...
const (
	...
	RaftService_HealthCheck_FullMethodName     = "/raft.RaftService/HealthCheck"
)
...
type RaftServiceClient interface {
	...
	HealthCheck(ctx context.Context, in *HealthCheckArgs, opts ...grpc.CallOption) (*HealthCheckReply, error)
}
...
func (c *raftServiceClient) HealthCheck(ctx context.Context, in *HealthCheckArgs, opts ...grpc.CallOption) (*HealthCheckReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HealthCheckReply)
	err := c.cc.Invoke(ctx, RaftService_HealthCheck_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RaftServiceServer interface {
	...
	HealthCheck(context.Context, *HealthCheckArgs) (*HealthCheckReply, error)
...
func (UnimplementedRaftServiceServer) HealthCheck(context.Context, *HealthCheckArgs) (*HealthCheckReply, error) {
...
func _RaftService_HealthCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftServiceServer).HealthCheck(ctx, req.(*HealthCheckArgs))
	}
	return interceptor(ctx, in, info, handler)
}
